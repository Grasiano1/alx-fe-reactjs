...
const HomePage = () => {
    ...
    return (
        <div className="container mx-auto p-4">
            <h1 className="text-3xl font-bold text-center mb-8 text-black">Our Recipes</h1>

            <Link to="/add-recipe" className="bg-green-500 text-white px-4 py-2 rounded-lg mb-6 inline-block">
                + Add New Recipe
            </Link>
